...
import { a11yNotificationPlugin } from '@/lib/swiper/a11yNotificationPlugin'
import { a11yPaginationPlugin } from '@/lib/swiper/a11yPaginationPlugin'
import { inertSlidesPlugin } from '@/lib/swiper/inertSlidesPlugin'
...
export abstract class SwiperElement extends BaseElementWithoutShadowDOM {
  ...
  private _initializeSwiper() {
    ...
    this.swiperOptions.modules = [
      ...(this.swiperOptions.modules || []),
      inertSlidesPlugin,
      a11yNotificationPlugin,
      a11yPaginationPlugin, // Overrides default arrow buttons
    ]
