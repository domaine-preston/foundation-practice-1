...
export class ModalDialog extends WithApiClientMixin(
  ...
  @property({ type: String, attribute: 'parent-class' })
  parentClass = ''
  ...
  protected firstUpdated(_changedProperties: PropertyValues): void {
    ...
    if (this.open || (this.modalIsOpen && !this.open)) {
      this.show()
    }
  }
  ...
  get dialogContentHTML() {
    ...
    return html`
      ${this._loadURLContentTask.render({
        pending: () =>
          html`<p class="caption p-md animate-pulse text-center">
            Loading...
          </p>`,
    ...
    return html`
      ...
      >
        ...
        >
          <div
            class="${this
              .headerClasses} bg-background px-sm py-xs sticky top-0 z-50 flex items-center justify-between"
          >
            <div
            ...
            <button
              ...
              class="focus-visible:ring-u-focus ml-auto inline-flex leading-none focus:outline-hidden focus-visible:ring-1"
            >
